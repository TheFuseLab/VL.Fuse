...
public class CompositionInput<T> : ShaderNode<T>
{
    ...
    public CompositionInput(NodeContext nodeContext, string theId, IComputeValue<T> theComposition) : base(nodeContext,
        theId)
    {
    ...
    protected override Dictionary<string, string> CreateTemplateMap()
    {
        ...
        foreach (var template in base.CreateTemplateMap()) result.Add(template.Key, template.Value);
