...
public class Int3Join : ResultNode<Int3>
{
    ...
    public Int3Join(NodeContext nodeContext, ShaderNode<int> x, ShaderNode<int> y, ShaderNode<int> z) : base(
        nodeContext, "Int3Join")
    {
        ShaderNode<int> @default = new ConstantValue<int>(0);
...
public class Int4Join : ResultNode<Int4>
{
    ...
    public Int4Join(NodeContext nodeContext, ShaderNode<int> x, ShaderNode<int> y, ShaderNode<int> z, ShaderNode<int> w)
        : base(nodeContext, "Int4Join")
    {
        ShaderNode<int> @default = new ConstantValue<int>(0);
...
public class IntJoinAdaptive<TIn, TExtension, TOut> : ResultNode<TOut> where TOut : struct
{
    ...
    public IntJoinAdaptive(NodeContext nodeContext, ShaderNode<TIn> theInput, ShaderNode<TExtension> theExtension) :
