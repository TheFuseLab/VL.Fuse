...
{
    public PassThroughDelegate(NodeContext nodeContext, string theName, AbstractShaderNode theValue) : base(nodeContext,
        theValue, null, theName)
    {
        // ReSharper disable once VirtualMemberCallInConstructor
...
{
    public PassVoid(NodeContext nodeContext, string theName, AbstractShaderNode theValue) : base(nodeContext, theValue,
        theName)
    {
    }
}
...
public class Output<T> : ShaderNode<T>
{
    ...
    public Output(NodeContext nodeContext, AbstractShaderNode theComputation, AbstractShaderNode theValue,
        ShaderNode<T> theDefault = null) : base(nodeContext, "AddOutput", theDefault)
    {
        _input = theValue;
...
public class Comment<T> : PassThroughNode<T>
{
    ...
    public Comment(NodeContext nodeContext, string theComment, ShaderNode<T> theIn) : base(nodeContext, theIn,
        "Comment")
    {
        _comment = theComment;
    }
...
{
    public Do(NodeContext nodeContext, ShaderNode<T> theIn, ShaderNode<GpuVoid> theCommand) : base(nodeContext, theIn,
        "Do")
    {
...
public class AddProperty<T> : PassThroughNode<T>
{
    ...
    public AddProperty(NodeContext nodeContext, ShaderNode<T> theIn, string thePropertyId, IList theResources) : base(
        nodeContext, theIn, "AddProperty")
    {
...
{
    public InjectToRegionDelegate(NodeContext nodeContext, Delegate<T> theDelegate) : base(nodeContext,
        "InjectToRegion", theDelegate)
    {
    }
}
...
public class AddToGraph<T> : ShaderNode<T>, IComputeVoid
{
    ...
    public AddToGraph(NodeContext nodeContext, ShaderNode<T> theMain, IEnumerable<AbstractShaderNode> theInputs,
        string name = "AddToGraph") : base(nodeContext, name)
    {
