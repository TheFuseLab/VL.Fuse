...
namespace Fuse
{
    public class SampleTextureNode<TTexCoord> : ShaderNode<Vector4>
    {
        ...
        public SampleTextureNode(GpuValue<Texture> theTexture, GpuValue<SamplerState> theSampler, GpuValue<TTexCoord> theTexCoords, GpuValue<float> theLevel, ConstantValue<Vector4> theDefault) : base( "sampleTexture", theDefault)
        {
            _texture = theTexture;
            _sampler = theSampler;
