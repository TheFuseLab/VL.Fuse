...
{
    protected ITextureAttributeNode(NodeContext nodeContext, string theName, AttributeType theType,
        AbstractShaderNode theValue = null) : base(nodeContext, theName, theType, theValue)
    {
    }
...
public class TextureAttribute<T> : ITextureAttributeNode<T>, ITextureAttribute where T : struct
{
    ...
    public TextureAttribute(NodeContext nodeContext, string theName, bool theIsDoubleBuffered,
        ShaderNode<T> theDefault = null) : base(nodeContext, theName, AttributeType.Texture)
    {
    ...
    public override Int3 Resolution => TextureInput?.Value == null
        ? new Int3(1)
        : new Int3(TextureInput.Value.Width, TextureInput.Value.Height, TextureInput.Value.Depth);
