...
namespace Fuse
{
    public class SetDynamicStructAttribute<T> : ShaderNode<GpuVoid>
    {
        ...
        public SetDynamicStructAttribute(GpuValue<GpuStruct> theStruct, GpuValue<T> theMember, GpuValue<T> theValue) : base("StructAttribute")
        {
            _struct = theStruct;
            _member = theMember;
            _value = theValue;
