...
public class DelegateRegion : Delegate<GpuVoid>
{
    public DelegateRegion(
        ...
        IEnumerable<BorderControlPointDescription> theOutputDescriptions) : base(nodeContext, null, null,
        "delegateRegion")
    {
                ...
                default:
                    /*
                        var myOutput = i >= outputs.Count
                            ...
                            : outputs[i];
                            */
                    var myFunctionParameter = AbstractCreation.AbstractFunctionParameter(subContextFactory,
                        outputDescriptions[i].TypeInfo, InputModifier.Out, i + inputs.Count);
                    var myAssign =
                        AbstractCreation.AbstractAssignNode(subContextFactory, myFunctionParameter, outputs[i]);
