...
public class Delegate<T> : ShaderNode<T>, IDelegate
{
    ...
    public Delegate(NodeContext nodeContext, AbstractShaderNode theDelegate, List<IFunctionParameter> theParameters,
        string theId = "Function", ShaderNode<T> theDefault = null) : base(nodeContext, theId, theDefault)
    {
    ...
    protected void BuildFunction(AbstractShaderNode theDelegate)
    {
        ...
        theDelegate.PropertiesForTree().ForEach(kv => { AddProperties(kv.Key, kv.Value); });
    }
...
{
    public Delegate1In1Out(NodeContext nodeContext, ShaderNode<TOut> theDelegate, FunctionParameter<TIn> theParam0,
        string theId = "Function", ShaderNode<TOut> theDefault = null) : base(nodeContext, theDelegate,
        new List<IFunctionParameter> { theParam0 }, theId, theDefault)
    {
    }
}
...
{
    public Delegate0In1Out(NodeContext nodeContext, ShaderNode<TOut> theDelegate, string theId = "Function",
        ShaderNode<TOut> theDefault = null) : base(nodeContext, theDelegate, new List<IFunctionParameter>(), theId,
        theDefault)
    {
    }
}
...
{
    public Delegate2In1Out(NodeContext nodeContext, ShaderNode<TOut> theDelegate, FunctionParameter<TIn0> theParam0,
        FunctionParameter<TIn1> theParam1, string theId = "Function", ShaderNode<TOut> theDefault = null) : base(
        nodeContext, theDelegate, new List<IFunctionParameter> { theParam0, theParam1 }, theId, theDefault)
    {
    }
}
...
{
    public Delegate3In1Out(NodeContext nodeContext, ShaderNode<TOut> theDelegate, FunctionParameter<TIn0> theParam0,
        FunctionParameter<TIn1> theParam1, FunctionParameter<TIn2> theParam2, string theId = "Function",
        ShaderNode<TOut> theDefault = null) : base(nodeContext, theDelegate,
        new List<IFunctionParameter> { theParam0, theParam1, theParam2 }, theId, theDefault)
    {
    }
}
...
public class Delegate4In1Out<TIn0, TIn1, TIn2, TIn3, TOut> : Delegate<TOut>
{
    ...
    ) : base(nodeContext, theDelegate, new List<IFunctionParameter> { theParam0, theParam1, theParam2, theParam3 },
        theId, theDefault)
    {
    }
}
...
public class Delegate5In1Out<TIn0, TIn1, TIn2, TIn3, TIn4, TOut> : Delegate<TOut>
{
    ...
    ) : base(nodeContext, theDelegate,
        new List<IFunctionParameter> { theParam0, theParam1, theParam2, theParam3, theParam4 }, theId, theDefault)
    {
    }
}