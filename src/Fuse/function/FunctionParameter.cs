...
{
    public FunctionParameter(NodeContext nodeContext, ShaderNode<T> theType,
        InputModifier theInputModifier = InputModifier.In, int theId = 0, string Name = "") : base(nodeContext,
        "arg_" + theId)
    {
