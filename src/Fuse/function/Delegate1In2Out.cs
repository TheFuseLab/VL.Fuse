...
public delegate void Delegate1In2OutUpdate<TIn, TOut1, TOut2>(object stateInput, out object stateOutput,
    ShaderNode<TIn> Input, out ShaderNode<TOut1> Output1, out ShaderNode<TOut2> Output2);
...
public class Delegate1In2Out<TIn, TOut1, TOut2> : DelegateStateful<Delegate<TOut1>>
{
    ...
    public void Update(Delegate1In2OutCreate create, Delegate1In2OutUpdate<TIn, TOut1, TOut2> update)
    {
        ...
        var inputParameter = new FunctionParameter<TIn>(nodeSubContextFactory.NextSubContext(), null);
        ...
        var do2 = new Do2<TOut1>(nodeSubContextFactory.NextSubContext(), sdfArgument,
