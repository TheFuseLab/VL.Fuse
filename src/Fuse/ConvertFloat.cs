...
public class Matrix2JoinVector2 : ResultNode<Matrix2>
{
    ...
    public Matrix2JoinVector2(NodeContext nodeContext, ShaderNode<Vector2> x, ShaderNode<Vector2> y) : base(nodeContext,
        "Matrix2Join")
    {
...
public class Matrix2Join : ResultNode<Matrix2>
{
    ...
    public Matrix2Join(NodeContext nodeContext, ShaderNode<float> the00, ShaderNode<float> the10,
        ShaderNode<float> the01, ShaderNode<float> the11) : base(nodeContext, "Matrix2Join")
    {
...
public class Matrix3Join : ResultNode<Matrix3>
{
    ...
    public Matrix3Join(NodeContext nodeContext, ShaderNode<Vector3> x, ShaderNode<Vector3> y, ShaderNode<Vector3> z) :
        base(nodeContext, "Matrix3Join")
    {
...
public class Matrix4Join : ResultNode<Matrix>
{
    ...
    public Matrix4Join(NodeContext nodeContext, ShaderNode<Vector4> x, ShaderNode<Vector4> y, ShaderNode<Vector4> z,
        ShaderNode<Vector4> w) : base(nodeContext, "Matrix4Join")
    {
...
public class Float2Join : ResultNode<Vector2>
{
    ...
    public Float2Join(NodeContext nodeContext, ShaderNode<float> x, ShaderNode<float> y) : base(nodeContext,
        "float2Join")
    {
        ShaderNode<float> @default = new ConstantValue<float>(0);
...
public class Float3Join : ResultNode<Vector3>
{
    ...
    public Float3Join(NodeContext nodeContext, ShaderNode<float> x, ShaderNode<float> y, ShaderNode<float> z) : base(
        nodeContext, "Float3Join")
    {
        ShaderNode<float> @default = new ConstantValue<float>(0);
...
public class Float4Join : ResultNode<Vector4>
{
    ...
    public Float4Join(NodeContext nodeContext, ShaderNode<float> x, ShaderNode<float> y, ShaderNode<float> z,
        ShaderNode<float> w) : base(nodeContext, "Float4Join")
    {
        ShaderNode<float> @default = new ConstantValue<float>(0);
...
public class FloatJoinAdaptive<TIn, TExtension, TOut> : ResultNode<TOut> where TOut : struct
{
    ...
    public FloatJoinAdaptive(NodeContext nodeContext, ShaderNode<TIn> theInput, ShaderNode<TExtension> theExtension) :
        base(nodeContext, "join")
    {
